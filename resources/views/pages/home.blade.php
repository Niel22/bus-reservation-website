                                    ...
                                    <div class="touritem-flexxer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h4 class="city fs-6 m-0 fw-bold">
                                                <span>{{ $route->terminal->name }}</span> to <span>{{ $route->destination }}</span>
                                            </h4>
                                        </div>
                                        <div class="detail ellipsis-container mt-2">
                                            <p class="m-0 text-md">Enjoy a comfortable ride from {{ $route->terminal->name }} to {{ $route->destination }}.</p>
                                        </div>
                                        <div class="flight-footer">
                                            <h5 class="fs-5 low-price m-0"><span class="tag-span">Seats:</span> <span class="price">{{ $route->seats }}</span></h5>
                                            <div class="rates">
                                                <div class="rat-reviews">
                                                    <span>Terminal Phone: {{ $route->terminal->phone }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
